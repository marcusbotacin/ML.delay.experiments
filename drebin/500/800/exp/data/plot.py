...
files = ["nodetection-800.csv"] #, "simple-detection.csv", "delay-50.csv", "delay-20.csv",  "drift-delay.csv", "drift.csv" ] #, "detection-thresh.csv", "delay-60.csv", "delay-40.csv", "delay10.csv", "drift-partial.csv", "1000-drift.csv"] #, "drift-ideal.csv"]
