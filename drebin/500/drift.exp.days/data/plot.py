...
files = ["nodetection.csv","best.csv", "ddm_81.csv", "ddm_61.csv", "ddm_41.csv", "ddm_31.csv", "ddm_21.csv", "ddm_11.csv", "ddm_1.csv","ddm3.csv"] 

# We need to specify labels, in the correct order
# Let's try to put labels in the exposure order, for easing the reading
labels = ["No Detection", "50%/6:1", "DDM+81 epochs", "DDM+61 epochs", "DDM+41 epochs","DDM+31 epochs","DDM+21 epochs", "DDM+11 epochs", "DDM+1 epoch", "50%/6:1 (DDM/Partial)"] 
