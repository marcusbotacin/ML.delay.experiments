...
files = ["noupdate71.csv","pseudo71.csv"] 
oracle_files = ["drift71ua.csv", "drift71.csv"]
pseudo_files = ["drift71ub.csv", "drift71p.csv"]


# We need to specify labels, in the correct order
# Let's try to put labels in the exposure order, for easing the reading
labels = ["DDM+71 epochs (No-2nd-Retrain)" ,"DDM+71 epochs (Pseudo)"] #, "50%/6:1 (DDM/Partial)"] 
...
fig.savefig('pseudp500-71-drift-noupdate.pdf')  
