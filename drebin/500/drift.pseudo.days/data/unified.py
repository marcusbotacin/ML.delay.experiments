...
files = ["ddm_71.csv", "pseudo71.csv", "ddm_21.csv", "pseudo21.csv", "ddm3.csv"] 

# We need to specify labels, in the correct order
# Let's try to put labels in the exposure order, for easing the reading
labels = ["DDM+71 epochs", "50%/0:1 (Pseudo+71)","DDM+21 epochs", "50%/0:1 (Pseudo+21)","50%/6:1 (DDM/Partial)"] 
...
fig.savefig('pseudp500-unified.pdf')  
