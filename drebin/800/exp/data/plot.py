...
files = ["nodetection-800.csv", "detect.csv", "delay-60.csv", "delay-40.csv", "drift-partial.csv", "drift.csv"] 

# We need to specify labels, in the correct order
# Let's try to put labels in the exposure order, for easing the reading
labels = ["No Detection", "50%/6:1", "50%/6:1 (DDM+60)", "50%/6:1 (DDM+40)", "50%/6:1 (DDM/Partial)", "50%/6:1 (DDM)"] 
#, "50%/6:1", "50%/6:1 (DDM+50)", "50%/6:1 (DDM+20)", "50%/6:1 (DDM/Partial)", "50%/6:1 (DDM)"] #, "50%/6:1 (DDM+60)", "50%/6:1 (DDM+40)", "50%/6:1 (DDM+10)", "50%/6:1 (DDM/Partial)", "50%/6:1 (DDM)"] 
