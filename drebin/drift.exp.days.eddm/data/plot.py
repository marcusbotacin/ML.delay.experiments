...
files = ["nodetection.csv","best.csv", "eddm_81.csv", "eddm_61.csv", "eddm_41.csv", "eddm_31.csv", "eddm_21.csv", "eddm_11.csv", "eddm_1.csv","eddm3.csv"] 

# We need to specify labels, in the correct order
# Let's try to put labels in the exposure order, for easing the reading
labels = ["No Detection", "50%/6:1", "EDDM+81 epochs", "EDDM+61 epochs", "EDDM+41 epochs","EDDM+31 epochs","EDDM+21 epochs", "EDDM+11 epochs", "EDDM+1 epoch", "50%/6:1 (EDDM/Partial)"] 
...
fig.savefig('drift.days.eddm.pdf')  
