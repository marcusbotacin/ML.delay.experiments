...
# Parse arguments
if len(sys.argv) != 4:
    print("Usage: python script.py <csv file> <delay days> <output file basename>")
    sys.exit(0)

CSV_FILE = sys.argv[1]
ORACLE_DELAY_DAYS = int(sys.argv[2])
...
model = Word2vec_RF_DDM(ORACLE_DELAY_DAYS)
...
f =  open(OUTPUT_BASE_FILE+'.prec.csv','w')
f2 = open(OUTPUT_BASE_FILE+'.exp2.csv','w')
